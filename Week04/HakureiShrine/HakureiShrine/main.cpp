...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if(glfwGetKey(window, 'A')) camMoveOffsetX -= 0.1f*shiftMove;
		if(glfwGetKey(window, 'D')) camMoveOffsetX += 0.1f*shiftMove;
		if(glfwGetKey(window, 'W')) camMoveOffsetZ -= 0.1f*shiftMove;
		if(glfwGetKey(window, 'S')) camMoveOffsetZ += 0.1f*shiftMove;
